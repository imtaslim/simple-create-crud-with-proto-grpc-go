...
var file_proto_category_category_proto_rawDesc = []byte{
	...
	0x73, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x32, 0x80, 0x02, 0x0a,
	...
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	...
	,
...
var file_proto_category_category_proto_depIdxs = []int32{
	...
	2, // 1: category.CategoryService.GetCategories:input_type -> category.GetCategoriesRequest
	2, // 2: category.CategoryService.GetCat:input_type -> category.GetCategoriesRequest
	1, // 3: category.CategoryService.GetCategory:output_type -> category.GetCategoryResponse
	1, // 4: category.CategoryService.GetCategories:output_type -> category.GetCategoryResponse
	1, // 5: category.CategoryService.GetCat:output_type -> category.GetCategoryResponse
...
type CategoryServiceClient interface {
	...
	GetCat(ctx context.Context, opts ...grpc.CallOption) (CategoryService_GetCatClient, error)
}
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *GetCategoriesRequest, opts ...grpc.CallOption) (CategoryService_GetCategoriesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CategoryService_serviceDesc.Streams[0], "/category.CategoryService/GetCategories", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *categoryServiceClient) GetCat(ctx context.Context, opts ...grpc.CallOption) (CategoryService_GetCatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CategoryService_serviceDesc.Streams[1], "/category.CategoryService/GetCat", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceGetCatClient{stream}
	return x, nil
}

type CategoryService_GetCatClient interface {
	Send(*GetCategoriesRequest) error
	CloseAndRecv() (*GetCategoryResponse, error)
	grpc.ClientStream
}

type categoryServiceGetCatClient struct {
	grpc.ClientStream
}

func (x *categoryServiceGetCatClient) Send(m *GetCategoriesRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceGetCatClient) CloseAndRecv() (*GetCategoryResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(GetCategoryResponse)
...
type CategoryServiceServer interface {
	...
	GetCat(CategoryService_GetCatServer) error
}
...
func (*UnimplementedCategoryServiceServer) GetCat(CategoryService_GetCatServer) error {
...
func _CategoryService_GetCat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).GetCat(&categoryServiceGetCatServer{stream})
}

type CategoryService_GetCatServer interface {
	SendAndClose(*GetCategoryResponse) error
	Recv() (*GetCategoriesRequest, error)
	grpc.ServerStream
}

type categoryServiceGetCatServer struct {
	grpc.ServerStream
}

func (x *categoryServiceGetCatServer) SendAndClose(m *GetCategoryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceGetCatServer) Recv() (*GetCategoriesRequest, error) {
	m := new(GetCategoriesRequest)
...
var _CategoryService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetCat",
			Handler:       _CategoryService_GetCat_Handler,
			ClientStreams: true,
		},
	},
